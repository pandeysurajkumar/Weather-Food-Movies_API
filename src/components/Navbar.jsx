...
function Navbar() {
  ...
  return (
    <nav className="navbar navbar-dark bg-dark p-3 text-center text-2 flex flex-wrap justify-center gap-2 items-center font-bold">
      <Link to="/" className="text-black m-2">
        Home
      </Link>
      <Link to="/about" className="text-black m-2">
        About
      </Link>
      <Link to="/contact" className="text-black m-2">
        Contact
      </Link>
